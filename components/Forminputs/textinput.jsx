...
export default function TextInput({ label, name, isRequired = true, type = "text", className = 'sm:col-span-2', register, errors,classNames,defaultValue="" }) {
  return (
    <div className={className}>
      ...
      <div className="mt-2">
        <input
          ...
          placeholder={`Type the ${label} title`}
        />
        {errors[name] && (
