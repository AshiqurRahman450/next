...
export default async function Newitem() {
  ...
  return (
    <div>
      {/* Header */}
      <Formheader title="New Item" href="/bill/inventory/items" />

      {/* Form */}
     <CreateItemForm categories={categories} units={units} brands={brands} warehouses={warehouses} supplier={suppiler}/>
    </div>
  );
}
